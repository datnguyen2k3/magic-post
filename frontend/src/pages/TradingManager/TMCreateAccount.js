...
const TMCreateAccount = () => {
    ...
    return <>
        <div className='tm-create-account'>
            <h2><b>Tạo tài khoản cho nhân viên điểm giao dịch</b></h2>
            <form onSubmit={handleSubmit}>
                <div className='tm-create-account-box'>
                    <div className='tm-create-account-box-1'>
                ...
                <input type='submit' value={'Hoàn thành tạo tài khoản'} className='tm-create-account-submit'></input>
            </form>
        </div>
    </>
}

export default TMCreateAccount