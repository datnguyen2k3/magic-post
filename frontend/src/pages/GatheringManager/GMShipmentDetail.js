import './GMShipmentDetail.scss'
import { useLocation } from 'react-router-dom';
import { useState, useEffect } from 'react';
import axios from 'axios';
import { ListGroup } from 'react-bootstrap';

const GMShipmentDetail = () => {
    ...
    useEffect(() => {
        axios.get(`${process.env.REACT_APP_BACKEND_URL}/gmshipments?${queryParams.toString()}`)
            .then(response => {
    ...
    return <>
        <div className='gm-shipment-detail'>
            {shipmentDetail ? <>
                <ListGroup>
...
export default GMShipmentDetail